...
function Navbar() {
  return (
    <div className='Navbar'>
      <nav className='pt-8 pb-4 px-8 lg:px-40 fixed top-0 z-50 w-screen bg-[#0e1111] text-white'>
        <div className='flex justify-between'>
          ...
          <div className='w-screen flex justify-center mx-2 lg:w-60'>
            <h2 className='text-lg p-1 font-bold'>HiYondika</h2>
          </div>
          <div className='flex items-center mx-2 lg:w-60 justify-end'>
